    ...
    <div className="bg-white text-slate-900 min-h-screen font-sans selection:bg-blue-500 selection:text-white antialiased">
      ...
      <div className="bg-slate-950 text-white text-[11px] font-medium py-2 px-4 border-b border-white/5 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2">
          ...
          <div className="flex items-center gap-4 text-slate-350">
            <span className="flex items-center gap-1"><CheckCircle className="w-3.5 h-3.5 text-blue-500" /> Live Mentorship</span>
            <span className="flex items-center gap-1"><CheckCircle className="w-3.5 h-3.5 text-blue-500" /> Career Preparation</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="max-w-2xl mx-auto text-center mb-16 space-y-3">
            <span className="text-blue-600 font-extrabold uppercase text-xs tracking-wider font-mono">14 Modules Curriculum</span>
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tight">Step-by-Step Pathway</h2>
            <p className="text-sm text-slate-650">A comprehensive hands-on curriculum mapped directly to AWS & Azure Certification requirements.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-8 bg-slate-50 border border-slate-200/60 rounded-2xl p-6 sm:p-8 min-h-[420px] flex flex-col justify-between">
              ...
              <div className="mt-8 pt-6 border-t border-slate-200/60 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <span className="text-[10px] font-mono text-slate-400 uppercase">Interactive Lab environment & console guides provided</span>
                <button 
