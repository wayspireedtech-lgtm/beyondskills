...
export default function Checkout() {
  ...
  const handleStartPayment = async (e) => {
    ...
    const options = {
      key: import.meta.env.VITE_RAZORPAY_KEY_ID || 'rzp_test_defaultKey123', // Falls back to test dummy key if env is missing
      amount: course.fee * 100, // Amount in paise (1 INR = 100 paise)
      currency: 'INR',
