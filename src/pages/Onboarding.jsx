      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 z-10 relative print:p-0">
        ...
        <div className="glass-panel p-8 rounded-2xl border border-slate-200 space-y-6 print:hidden">
          ...
          <div className="border-t border-slate-200/60 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <button onClick={() => setInvoiceOpen(true)} className="w-full sm:w-auto bg-slate-100 hover:bg-white/10 border border-slate-200 text-slate-900 font-bold px-6 py-3 rounded-xl text-xs uppercase tracking-wider flex items-center justify-center space-x-2">
              <FileText className="w-4.5 h-4.5 text-brand-purple" />
              <span>Generate PDF Invoice</span>
            </button>

            <button onClick={handleGoToDashboard} className="w-full sm:w-auto bg-gradient-to-r from-brand-purple to-brand-blue hover:brightness-110 text-slate-900 font-bold px-6 py-3 rounded-xl text-xs uppercase tracking-wider flex items-center justify-center space-x-2 shadow-lg shadow-brand-purple/15 hover:scale-105 transition-all">
