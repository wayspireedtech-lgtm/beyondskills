          ...
          {featuredCourses.map((course) => {
            ...
            return (
              <div 
                key={course.id} 
                onClick={() => {
                  const targetPath = course.id === 'full-stack-web' ? '/programs/full-stack-web-development' : 
                                     ['artificial-intelligence', 'machine-learning'].includes(course.id) ? '/programs/ai-data-science' :
                                     `/course/${course.id}`;
                  navigate(targetPath);
                }}
                  ...
                  <div>
                    ...
                    <div className="border-t border-white/10 pt-4 flex items-center justify-between">
                      ...
                      <div className="flex space-x-1.5">
                        <Link 
                          to={course.id === 'full-stack-web' ? '/programs/full-stack-web-development' : 
                              ['artificial-intelligence', 'machine-learning'].includes(course.id) ? '/programs/ai-data-science' :
                              `/course/${course.id}/brochure`}
